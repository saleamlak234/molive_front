...
export default function MLMTree() {
  ...
  const renderTreeNode = (node: TreeNode, level: number = 0) => {
    ...
    const getLevelColor = (level: number) => {
      switch (level) {
        case 1: return 'border-emerald-200 bg-emerald-50';
        ...
        <div className="mt-8 bg-white rounded-xl shadow-sm p-6 border border-gray-200">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
            <div className="flex items-center space-x-3 p-3 bg-emerald-50 rounded-lg">
              ...
              <div>
                <p className="font-medium text-emerald-900">Level 1</p>
                <p className="text-sm text-emerald-700">8% Commission</p>
              </div>
            </div>
            <div className="flex items-center space-x-3 p-3 bg-green-50 rounded-lg">
              ...
              <div>
                ...
                <p className="text-sm text-green-700">6% Commission</p>
              </div>
            </div>
            <div className="flex items-center space-x-3 p-3 bg-purple-50 rounded-lg">
              ...
              <div>
                ...
                <p className="text-sm text-purple-700">4% Commission</p>
              </div>
            </div>
