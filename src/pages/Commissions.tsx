      ...
      <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 gap-6 mb-8 md:grid-cols-2 lg:grid-cols-4">
          ...
          <div className="p-6 bg-white border border-gray-200 shadow-sm rounded-xl">
            ...
            <div className="flex items-center mt-4 text-sm">
              <span className="text-emerald-600">Level 1 team members</span>
            </div>
          </div>
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-center justify-between p-4 rounded-lg bg-green-50">
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      <p className="font-medium text-gray-900">Level 2 (6%)</p>
                ...
                <div className="flex items-center justify-between p-4 rounded-lg bg-purple-50">
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      <p className="font-medium text-gray-900">Level 3 (4%)</p>
                ...
                <div className="flex items-center justify-between p-4 rounded-lg bg-orange-50">
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      <p className="font-medium text-gray-900">admin(nolevel)</p>
                      <p className="text-sm text-gray-600">no level referrals</p>
                    </div>
                  </div>
                  <p className="font-semibold text-gray-900">
                          ...
                          <div>
                            <div className="flex items-center space-x-2">
                              <h4 className="font-medium text-gray-900">
                                Commission from {commission.fromUser?.fullName || 'Unknown user'}
                              </h4>
          ...
          <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
            <div>
              ...
              <ul className="space-y-2 text-primary-700">
                ...
                <li className="flex items-center space-x-2">
                  <ArrowRight className="w-4 h-4" />
                  <span>Level 2: 6% commission</span>
                </li>
                <li className="flex items-center space-x-2">
                  <ArrowRight className="w-4 h-4" />
                  <span>Level 3: 4% commission</span>
                </li> *
